...
from models.utils.modules import FeatResBlock,UpConvResBlock,DownConvResBlock,ResBlock, SPADEDecoder
...
import math
from models.utils.modules import ConvResBlock
from models.utils.vit import TransformerBlock, CrossAttentionModule
...
class IMFModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.frame_decoder = FrameDecoder(self.feature_dims, self.spatial_dims)
    ...
    def decode_latent_tokens(self, f_r, t_r, t_c):
        ...
        return self.frame_decoder(f_r, aligned_features)
