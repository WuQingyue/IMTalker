...
def process_videos(video_list_path, video_dir, output_root_dir):
    ...
    for vid_id in video_ids:
        candidates = list(video_dir.glob(f"{vid_id}.*"))
        if not candidates:
...
# ==== 修改这里 ====
video_list_path = r"E:\codes\codes\FM\val_ids.txt"
video_dir = r"E:\data\hdtf\video_25fps"
output_dir = r"D:\eval\audio_drive\vox2"
# ===================

process_videos(video_list_path, video_dir, output_dir)
