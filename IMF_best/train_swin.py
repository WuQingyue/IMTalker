...
from networks.model_swin import IMFModel
...
if __name__ == "__main__":
    ...
    parser.add_argument('--swin_res_threshold', type=int, default=64, help='Resolution threshold to switch to Swin Attention.')
